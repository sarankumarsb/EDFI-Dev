...
namespace EdFi.Dashboards.Application.Resources.Tests
{
    /// <summary>
    ...
    public abstract class When_serializing_models_in_this_assembly<TSerializer, TSerializationAttribute>
        : When_serializing_all_models_in_assembly<Marker_EdFi_Dashboards_Application_Resources_Models, TSerializer, TSerializationAttribute>
