...
namespace EdFi.Dashboards.Application.Resources.Tests.LocalEducationAgency
{
    public class GoalPlanningServiceFixtureBase : TestFixtureBase
    {
        ...
        protected Mock<IDomainMetricService<LocalEducationAgencyMetricInstanceSetRequest>> domainMetricService = new Mock<IDomainMetricService<LocalEducationAgencyMetricInstanceSetRequest>>();
        ...
        protected IQueryable<EducationOrganizationGoalPlanning> GetSuppliedEducationOrganizationGoalPlanning()
        {
            var list = new List<EducationOrganizationGoalPlanning>
                           {
                               new EducationOrganizationGoalPlanning { EducationOrganizationId = suppliedLocalEducationAgencyId, MetricId = suppliedMetricId1, Goal = suppliedProposedGoal1, EducationOrganizationGoalPlanningId = suppliedGoalPlanningId },
                               new EducationOrganizationGoalPlanning { EducationOrganizationId = suppliedLocalEducationAgencyId, MetricId = suppliedMetricId2, Goal = suppliedProposedGoal2, EducationOrganizationGoalPlanningId = 2 },
                               new EducationOrganizationGoalPlanning { EducationOrganizationId = suppliedLocalEducationAgencyId, MetricId = suppliedMetricId3, Goal = suppliedProposedGoal3, EducationOrganizationGoalPlanningId = 3 },
                               new EducationOrganizationGoalPlanning { EducationOrganizationId = suppliedLocalEducationAgencyId + 1, MetricId = suppliedMetricId1, Goal = .4m, EducationOrganizationGoalPlanningId = 9999 },
                               new EducationOrganizationGoalPlanning { EducationOrganizationId = suppliedLocalEducationAgencyId, MetricId = suppliedMetricId1 + 123, Goal = .4m, EducationOrganizationGoalPlanningId = 9999 },
                           };
        ...
        protected IQueryable<EducationOrganizationGoal> GetSuppliedEducationOrganizationGoals()
        {
            var list = new List<EducationOrganizationGoal>
                           {
                               new EducationOrganizationGoal { EducationOrganizationId = suppliedLocalEducationAgencyId, MetricId = suppliedMetricId1, Goal = suppliedGoal1, IsUpdated = true, EducationOrganizationGoalId = 1 },
                               new EducationOrganizationGoal { EducationOrganizationId = suppliedLocalEducationAgencyId, MetricId = suppliedMetricId2, Goal = suppliedGoal2, IsUpdated = true, EducationOrganizationGoalId = 2 },
                               new EducationOrganizationGoal { EducationOrganizationId = suppliedLocalEducationAgencyId, MetricId = suppliedMetricId3, Goal = suppliedGoal3, IsUpdated = true, EducationOrganizationGoalId = 3 },
                               new EducationOrganizationGoal { EducationOrganizationId = suppliedLocalEducationAgencyId + 1, MetricId = suppliedMetricId1, Goal = .4m, IsUpdated = true, EducationOrganizationGoalId = 9999 },
                               new EducationOrganizationGoal { EducationOrganizationId = suppliedLocalEducationAgencyId, MetricId = suppliedMetricId1 + 123, Goal = .4m, IsUpdated = true, EducationOrganizationGoalId = 9999 },
                               new EducationOrganizationGoal { EducationOrganizationId = suppliedLocalEducationAgencyId, MetricId = suppliedMetricId1, Goal = .12345m, IsUpdated = false, EducationOrganizationGoalId = 9999 },
                           };
            return list.AsQueryable();
        }
        ...
        {
            var service = new GoalPlanningService(goalPlanningRepository.Object, goalRepository.Object, rootMetricNodeResolver.Object, domainMetricService.Object);
            actualResults = service.Get(request);
        }
    }

    public class When_loading_all_goal_planning_for_a_local_education_agency : GoalPlanningServiceFixtureBase
    {
        protected override void EstablishContext()
        {
            rootMetricNodeResolver.Setup(x => x.GetRootMetricNode()).Returns(new MetricMetadataNode(new TestMetricMetadataTree()) { MetricId = 888, MetricVariantId = 888000 });
            domainMetricService.Setup(x => x.Get(It.Is<LocalEducationAgencyMetricInstanceSetRequest>(i => i.LocalEducationAgencyId == suppliedLocalEducationAgencyId && i.MetricVariantId == 888000)))
                                            .Returns(GetMetricTree());

            request = GoalPlanningGetRequest.Create(suppliedLocalEducationAgencyId, null);
            base.EstablishContext();
        }
        ...
        public void Should_load_correct_proposed_goals()
        {
            ...
            Assert.That(proposedGoal.EducationOrganizationId, Is.EqualTo(suppliedLocalEducationAgencyId));
        ...
        public void Should_load_correct_published_goals()
        {
            ...
            Assert.That(publishedGoal.EducationOrganizationId, Is.EqualTo(suppliedLocalEducationAgencyId));
    ...
    public class When_loading_goal_planning_for_a_container_metric : GoalPlanningServiceFixtureBase
    {
        protected override void EstablishContext()
        {
            ...
            domainMetricService.Setup(x => x.Get(It.Is<LocalEducationAgencyMetricInstanceSetRequest>(i => i.LocalEducationAgencyId == suppliedLocalEducationAgencyId && i.MetricVariantId == suppliedMetricVariantId102)))
                                            .Returns(new MetricTree(rootNode.DescendantsOrSelf.Single(x => x.MetricId == suppliedMetricId102)));

            request = GoalPlanningGetRequest.Create(suppliedLocalEducationAgencyId, suppliedMetricVariantId102);
            base.EstablishContext();
        }
    ...
    public class When_loading_goal_planning_for_a_single_metric : GoalPlanningServiceFixtureBase
    {
        protected override void EstablishContext()
        {
            ...
            domainMetricService.Setup(x => x.Get(It.Is<LocalEducationAgencyMetricInstanceSetRequest>(i => i.LocalEducationAgencyId == suppliedLocalEducationAgencyId && i.MetricVariantId == suppliedMetricVariantId1)))
                                            .Returns(new MetricTree(rootNode.DescendantsOrSelf.Single(x => x.MetricVariantId == suppliedMetricVariantId1)));
            request = GoalPlanningGetRequest.Create(suppliedLocalEducationAgencyId, suppliedMetricVariantId1);
            base.EstablishContext();
        }
        ...
        public void Should_load_correct_proposed_goals()
        {
            ...
            Assert.That(actualResults.ProposedGoals.ElementAt(0).EducationOrganizationId, Is.EqualTo(suppliedLocalEducationAgencyId));
        }
        ...
        public void Should_load_correct_published_goals()
        {
            ...
            Assert.That(actualResults.PublishedGoals.ElementAt(0).EducationOrganizationId, Is.EqualTo(suppliedLocalEducationAgencyId));
    ...
    public class When_adding_goal_planning : When_loading_goal_planning_for_a_container_metric
    {
        ...
        public void Should_add_correct_goals()
        {
            ...
            Assert.That(postedGoalPlanning.AsQueryable().Count(x => x.EducationOrganizationId == suppliedLocalEducationAgencyId && x.MetricId == suppliedMetricId1 + 10 && x.Goal == .888m), Is.EqualTo(1));
    ...
    public class When_updating_goal_planning : When_loading_goal_planning_for_a_container_metric
    {
        ...
        public void Should_update_correct_goals()
        {
            Assert.That(postedGoalPlanning.Count, Is.EqualTo(3));
            Assert.That(postedGoalPlanning.AsQueryable().Count(x => x.EducationOrganizationGoalPlanningId == suppliedGoalPlanningId), Is.EqualTo(1));
            Assert.That(postedGoalPlanning.AsQueryable().Count(x => x.EducationOrganizationId == suppliedLocalEducationAgencyId && x.MetricId == suppliedMetricId1 && x.Goal == .111m), Is.EqualTo(1));
