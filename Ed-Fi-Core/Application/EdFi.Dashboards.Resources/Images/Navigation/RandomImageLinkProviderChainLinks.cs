...
{
    public class RandomImageLinkProviderChainLinks
    {
    }

    public class StudentRandomImageLinkProvider : ChainOfResponsibilityBase<IImageLinkProvider, ImageRequestBase, String>, IImageLinkProvider
    {
        private const string personImageFilePathFormat = "~/Core_Content/Images/Students/{0}{1}{2}";

        public StudentRandomImageLinkProvider(IImageLinkProvider next) : base(next){}
    ...
    public class StaffRandomImageLinkProvider : ChainOfResponsibilityBase<IImageLinkProvider, ImageRequestBase, String>, IImageLinkProvider
    {
        private const string personImageFilePathFormat = "~/Core_Content/Images/Students/{0}{1}{2}";

        public StaffRandomImageLinkProvider(IImageLinkProvider next) : base(next) { }
    ...
    public class SchoolRandomImageLinkProvider : ChainOfResponsibilityBase<IImageLinkProvider, ImageRequestBase, String>, IImageLinkProvider
    {
        private const string schoolImageFilePathFormat = "~/Core_Content/Images/EducationOrganization/{0}{1}{2}";

        public SchoolRandomImageLinkProvider(IImageLinkProvider next) : base(next) { }
    ...
    public class LocalEducationAgencyRandomImageLinkProvider : ChainOfResponsibilityBase<IImageLinkProvider, ImageRequestBase, String>, IImageLinkProvider
    {
        private const string schoolImageFilePathFormat = "~/Core_Content/Images/EducationOrganization/{0}{1}{2}";

        public LocalEducationAgencyRandomImageLinkProvider(IImageLinkProvider next) : base(next) { }
