...
{
    public abstract class AssessmentDetailsProviderFixture : TestFixtureBase
    {
        protected AssessmentDetailsProvider provider;
        protected IEnumerable<StudentMetric> studentMetrics; 
        protected int[] objectives;
        protected StudentWithMetrics.IndicatorMetric indicatorMetric;
        protected StudentWithMetricsAndAssessments studentWithMetricsAndAssessments;
    ...
    public class When_calling_assessment_details_provider_for_get_metric_ids_for_objectives_for_reading : AssessmentDetailsProviderFixture
    {
    ...
    public class When_calling_assessment_details_provider_for_get_metric_ids_for_objectives_for_science : AssessmentDetailsProviderFixture
    {
        protected override void ExecuteTest()
        {
    ...
    public class When_calling_assessment_details_provider_for_student_assessment_init_for_reading : AssessmentDetailsProviderFixture
    {
        protected override void ExecuteTest()
        {
    ...
    public class When_calling_assessment_details_provider_for_student_assessment_init_for_math : AssessmentDetailsProviderFixture
    {
        protected override void ExecuteTest()
        {
