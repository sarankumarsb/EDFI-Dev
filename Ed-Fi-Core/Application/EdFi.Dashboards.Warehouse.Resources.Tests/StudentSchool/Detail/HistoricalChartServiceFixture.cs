...
namespace EdFi.Dashboards.Warehouse.Resources.Tests.StudentSchool.Detail
{
    [TestFixture]
    public class When_getting_model_for_student_historical_chart_with_no_period_id : TestFixtureBase
    {
        protected IRepository<StudentMetricHistorical> studentMetricHistoricalRepository;
        ...
        protected IQueryable<StudentMetricHistorical> suppliedStudentMetricHistorical;
        ...
        {
            studentMetricHistoricalRepository = mocks.StrictMock<IRepository<StudentMetricHistorical>>();
            ...
            suppliedStudentMetricHistorical = GetSuppliedStudentMetricHistorical();

            Expect.Call(warehouseAvailabilityProvider.Get()).Return(true);
            Expect.Call(metricNodeResolver.GetMetricNodeForStudentFromMetricVariantId(schoolId1, metricVariantId1)).Return(GetSuppliedMetricMetadataNode());
            Expect.Call(studentMetricHistoricalRepository.GetAll()).Repeat.Any().Return(suppliedStudentMetricHistorical);
            Expect.Call(metricGoalProvider.GetMetricGoal(suppliedStudentMetricInstanceSetKey1, metricId1)).Return(schoolGoal1);
            //This is tested elsewhere so we ignore and return a fixed value.
            Expect.Call(metricStateProvider.GetState(1, ".0", "System.IgnoreThisParam")).IgnoreArguments().Repeat.Any().Return(new State(MetricStateType.Good, "Good"));
            ...
            Expect.Call(
                ...
                .Constraints(
                    new ActionConstraint<StudentSchoolMetricInstanceSetRequest>(x =>
                    {
                        ...
                        Assert.That(x.StudentUSI == studentUSI1);
                    })
                ).Return(suppliedStudentMetricInstanceSetKey1);
        ...
        protected IQueryable<StudentMetricHistorical> GetSuppliedStudentMetricHistorical()
        {
            var list = new List<StudentMetricHistorical>
                        {
                            new StudentMetricHistorical{PeriodIdentifierId = 1, PeriodTypeId = 1, PeriodType = "Day", StartDate = new DateTime(2011,1,1), EndDate = new DateTime(2011,1,1), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/01", Value = ".80", ValueType = "System.Double", Numerator = 80, Denominator = 100, Flag = true, TrendDirection = 1},
                            new StudentMetricHistorical{PeriodIdentifierId = 2, PeriodTypeId = 1, PeriodType = "Day", StartDate = new DateTime(2011,1,2), EndDate = new DateTime(2011,1,2), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/02", Value = ".95", ValueType = "System.Double", Numerator = 95, Denominator = 100, Flag = null, TrendDirection = null},
                            new StudentMetricHistorical{PeriodIdentifierId = 3, PeriodTypeId = 1, PeriodType = "Day", StartDate = new DateTime(2011,1,3), EndDate = new DateTime(2011,1,3), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/03", Value = ".55", ValueType = "System.Double", Numerator = 110, Denominator = 200, Flag = true, TrendDirection = 1},
                            new StudentMetricHistorical{PeriodIdentifierId = 4, PeriodTypeId = 1, PeriodType = "Day", StartDate = new DateTime(2011,1,1), EndDate = new DateTime(2011,1,1), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/04", Value = ".44", ValueType = "System.Double", Numerator = 44, Denominator = 100, Flag = true, TrendDirection = 1},
                            new StudentMetricHistorical{PeriodIdentifierId = 5, PeriodTypeId = 1, PeriodType = "Day", StartDate = new DateTime(2011,1,2), EndDate = new DateTime(2011,1,2), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/05", Value = ".79", ValueType = "System.Double", Numerator = 79, Denominator = 100, Flag = null, TrendDirection = null},
                            new StudentMetricHistorical{PeriodIdentifierId = 6, PeriodTypeId = 1, PeriodType = "Day", StartDate = new DateTime(2011,1,3), EndDate = new DateTime(2011,1,3), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/06", Value = ".67", ValueType = "System.Double", Numerator = 67, Denominator = 100, Flag = true, TrendDirection = 1},

                            new StudentMetricHistorical{PeriodIdentifierId = 1, PeriodTypeId = 3, PeriodType = "Grading Period", StartDate = new DateTime(2011,1,1), EndDate = new DateTime(2011,1,31), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/01", Value = ".81", ValueType = "System.Double", Numerator = 81, Denominator = 100, Flag = true, TrendDirection = 1},
                            new StudentMetricHistorical{PeriodIdentifierId = 2, PeriodTypeId = 3, PeriodType = "Grading Period", StartDate = new DateTime(2011,2,1), EndDate = new DateTime(2011,1,28), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/02", Value = ".92", ValueType = "System.Double", Numerator = 92, Denominator = 100, Flag = null, TrendDirection = null},
                            new StudentMetricHistorical{PeriodIdentifierId = 3, PeriodTypeId = 3, PeriodType = "Grading Period", StartDate = new DateTime(2011,3,1), EndDate = new DateTime(2011,1,31), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/03", Value = ".53", ValueType = "System.Double", Numerator = 53, Denominator = 100, Flag = true, TrendDirection = 1},

                            new StudentMetricHistorical{PeriodIdentifierId = 1, PeriodTypeId = 2, PeriodType = "Week", StartDate = new DateTime(2011,1,1), EndDate = new DateTime(2011,1,5), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/01", Value = ".80", ValueType = "System.Double", Numerator = 80, Denominator = 100, Flag = true, TrendDirection = 1},
                            new StudentMetricHistorical{PeriodIdentifierId = 4, PeriodTypeId = 2, PeriodType = "Week", StartDate = new DateTime(2011,1,16), EndDate = new DateTime(2011,1,20), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/03", Value = ".55", ValueType = "System.Double", Numerator = 110, Denominator = 200, Flag = true, TrendDirection = 1},
                            new StudentMetricHistorical{PeriodIdentifierId = 2, PeriodTypeId = 2, PeriodType = "Week", StartDate = new DateTime(2011,1,6), EndDate = new DateTime(2011,1,10), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/02", Value = ".95", ValueType = "System.Double", Numerator = 95, Denominator = 100, Flag = null, TrendDirection = null},
                            new StudentMetricHistorical{PeriodIdentifierId = 3, PeriodTypeId = 2, PeriodType = "Week", StartDate = new DateTime(2011,1,11), EndDate = new DateTime(2011,1,15), MetricId = metricId1, StudentUSI = studentUSI1, SchoolId = schoolId1, Context = "01/03", Value = ".55", ValueType = "System.Double", Numerator = 110, Denominator = 200, Flag = true, TrendDirection = 1},
                        };
        ...
        {
            var maxPeriodId = suppliedStudentMetricHistorical.Max(x => x.PeriodTypeId);
            var suppliedPeriod = suppliedStudentMetricHistorical.First(x => x.PeriodTypeId == maxPeriodId);
        ...
        public void Should_calculate_available_periods_correctly()
        {
            ...
            for (int i = 0; i < suppliedAvaialablePeriods.Count; i++)
            {
                ...
                Assert.That(actualModel.AvailablePeriods[i].Id, Is.EqualTo(suppliedAvaialablePeriods[i].Id), "The IDS don't Match...Could be a sorting problem.");
        ...
        public virtual void Should_calculate_chart_data_correctly()
        {
            ...
            var defaultPeriodId = suppliedStudentMetricHistorical.Max(x => x.PeriodTypeId);
            var defaultPeriodData = suppliedStudentMetricHistorical.Where(x => x.PeriodTypeId == defaultPeriodId).OrderBy(x => x.PeriodIdentifierId).ToList();
        ...
        {
            var data = (from d in suppliedStudentMetricHistorical
    ...
    [TestFixture]
    public class When_getting_model_for_student_historical_chart_with_supplied_period_id : When_getting_model_for_student_historical_chart_with_no_period_id
    {
        protected override void ExecuteTest()
        {
            var service = new HistoricalChartService(studentMetricHistoricalRepository, metricGoalProvider, metricStateProvider, metricInstanceSetKeyResolver, trendRenderingDispositionProvider, metricNodeResolver, warehouseAvailabilityProvider);
        ...
        {
            var suppliedPeriod = suppliedStudentMetricHistorical.First(x => x.PeriodTypeId == periodId1);
            //The count should be the same.			
            Assert.That(actualModel.DrillDownTitle, Is.EqualTo(suppliedPeriod.PeriodType));
        }
