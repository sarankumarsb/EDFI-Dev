...
using EdFi.Dashboards.Warehouse.Resource.Models;
using NUnit.Framework;

namespace EdFi.Dashboards.Warehouse.Resources.Tests
{
    /// <summary>
    ...
    public abstract class When_serializing_models_in_this_assembly<TSerializer, TSerializationAttribute>
        : When_serializing_all_models_in_assembly<Marker_EdFi_Dashboards_Warehouse_Resources_Models, TSerializer, TSerializationAttribute>
